...
(function () {
  const basicAlert = document.querySelector('#basic-alert'),
    ...
    // approve
    approveCancel = document.querySelector('#approveCancel'),
    
    // survey
    surveyUpdate = document.querySelector('#surveyUpdate'),
    
    
    //hj추가
    todoDelConfirm = document.querySelector('#todoDelConfirm'),
    todoInSuccess = document.querySelector('#todoInSuccess');
  ...
  // todoInSuccess - hj추가
  if (todoInSuccess) {
    todoInSuccess.addEventListener('click', function () {
      Swal.fire({
        title: '등록 완료!',
        icon: 'success',
        customClass: {
  ...
  // todoDelConfirm - hj추가
  if (todoDelConfirm) {
    todoDelConfirm.onclick = function () {
      Swal.fire({
        title: '삭제하시겠습니까?',
        icon: 'warning',
        showCancelButton: true,
